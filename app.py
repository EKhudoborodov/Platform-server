    ...
    if roles == None:
        ...
        if records == []:
            ...
            if records[0][1] == 1:
                ...
                return render_template('draft.html', ban=ban, a=roles[0], m=roles[1], w=roles[2], new_publish=new_publish, text=text, title=title, author=author, reason=reason, denied=1)
    else:
        return redirect(url_for('.home'))
